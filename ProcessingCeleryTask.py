...
from GlobalConfigs import MONGO_REVIEWS_IP, MONGO_REVIEWS_PORT, MONGO_NP_RESULTS_IP,\
        MONGO_NP_RESULTS_PORT, MONGO_NP_RESULTS_DB, MONGO_SENTENCES_NP_RESULTS_COLLECTION, MONGO_REVIEWS_NP_RESULTS_COLLECTION 
