...
App.BodyView = Backbone.View.extend({
	...
	initialize: function(){
		...
		$(".submitText").click(function(){
			...
			var jqhr = $.post(window.sentenceTokenization, {"text": text, "link": null})
		...
		$('.modal-trigger').leanModal({
				...
				complete: function() {
					...
					var jqhr = $.post(window.sentenceTokenization, {"text": null, "link": __value})
...
App.SentencesView = Backbone.View.extend({
		...
		sendButton: function(event){
			...
			var jqhr = $.post(window.uploadSentence, {"sentence": this.model.sentence, "sentiment": self.$(".polarity").val(), "tag": self.$(".tags").val(), "subtag": self.$(".subTags").val()} )
			jqhr.done(function(data){
				console.log(data)
