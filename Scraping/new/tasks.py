...
class process_eatery(celery.Task):
	...
	def on_failure(self, exc, task_id, args, kwargs, einfo):
		print "fucking faliure occured process_eatery"
		self.retry(exc=exc)
...
class process_page(celery.Task):
	...
	def on_failure(self, exc, task_id, args, kwargs, einfo):
		print "fucking faliure occured in process_page"
		self.retry(exc=exc)
...
def runn(url, number_of_restaurants, skip, Type_of_url):
	...
	Args:
		...
		*
		...
		P.S. number_of_restaurants and skip SHOULD BE SET 0 FOR NOW.
	...
	Usage:
		...
		runn.apply_async(["https://www.zomato.com/ncr/hops-n-brew-the-microbrewery-sector-29-gurgaon",0,0,"one_eatery"])
		runn.apply_async(["https://www.zomato.com/ncr/south-delhi-restaurants?page=20",0,0,"one_page"])
		runn.apply_async(["https://www.zomato.com/ncr/malviya-nagar-delhi-restaurants",0,0,"local_area"])
		runn.apply_async(["https://www.zomato.com/ncr",0,0,"big_area"])
